...
(() => {
  ...
  if (form) {
    form.addEventListener("submit", (e) => {
      ...
      setTimeout(() => {
        ...
        setStatus("Demo mode: Credentials verified. Backend flow can be connected here.", "success");
      }, 1000);
    });
  }
  ...
  if (googleButton) {
    googleButton.addEventListener("click", () => {
      ...
      setTimeout(() => {
        ...
        setStatus("Demo mode: Google OAuth flow ready for backend integration.", "success");
      }, 950);
    });
  }
  ...
  if (forgotLink) {
    forgotLink.addEventListener("click", (e) => {
      e.preventDefault();
      setStatus("Password reset instructions will be sent to your campus email.");
    });
  }
  ...
  if (signupLink) {
    signupLink.addEventListener("click", (e) => {
      e.preventDefault();
      setStatus("Campus Fix AI registration portal will open here.");
    });
  }
})();